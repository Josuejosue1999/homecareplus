...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesMentalHealthPage(),
  ));
}

class FacilitiesMentalHealthPage extends StatelessWidget {
  const FacilitiesMentalHealthPage({super.key});
