...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesCommunityHealthPage(),
  ));
}

class FacilitiesCommunityHealthPage extends StatelessWidget {
  const FacilitiesCommunityHealthPage({super.key});
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _clinicBox('assets/community.png'),
                    _clinicBox('assets/community.png'),
                  ],
                ),
              ),
