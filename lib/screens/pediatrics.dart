...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesPediatricsPage(),
  ));
}

class FacilitiesPediatricsPage extends StatelessWidget {
  const FacilitiesPediatricsPage({super.key});
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _clinicBox('assets/pediatrie.jpeg'),
                    _clinicBox('assets/pediatrie.jpeg'),
                  ],
                ),
              ),
