...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesGeneralHospitalsPage(),
  ));
}

class FacilitiesGeneralHospitalsPage extends StatelessWidget {
  const FacilitiesGeneralHospitalsPage({super.key});
