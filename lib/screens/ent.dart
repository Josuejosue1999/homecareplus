...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesENTPage(),
  ));
}

class FacilitiesENTPage extends StatelessWidget {
  const FacilitiesENTPage({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Facilities / ENT (Ear, Nose, Throat) Clinics',
                style: TextStyle(
                  fontSize: 24,
