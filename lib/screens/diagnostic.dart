...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesDiagnosticPage(),
  ));
}

class FacilitiesDiagnosticPage extends StatelessWidget {
  const FacilitiesDiagnosticPage({super.key});
