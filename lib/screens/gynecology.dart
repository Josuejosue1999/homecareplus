...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesGynecologyPage(),
  ));
}

class FacilitiesGynecologyPage extends StatelessWidget {
  const FacilitiesGynecologyPage({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Facilities / Gynecology & Fertility Centers',
                style: TextStyle(
                  fontSize: 24,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _clinicBox('assets/gynecology.jpeg'),
                    _clinicBox('assets/gynecology.jpeg'),
                  ],
                ),
              ),
