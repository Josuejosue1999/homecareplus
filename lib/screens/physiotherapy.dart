...
void main() {
  runApp(const MaterialApp(
    ...
    home: FacilitiesPhysiotherapyPage(),
  ));
}

class FacilitiesPhysiotherapyPage extends StatelessWidget {
  const FacilitiesPhysiotherapyPage({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Facilities / Physiotherapy Centers',
                style: TextStyle(
                  fontSize: 24,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _clinicBox('assets/physiotherapy.jpg'),
                    _clinicBox('assets/physiotherapy.jpg'),
                  ],
                ),
              ),
